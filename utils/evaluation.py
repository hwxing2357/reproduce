...
from backbone.neural_processes.NPCL_MoE import get_k_nearest_by_variance, get_k_nearest_by_uncertainty
# from backbone.neural_processes.NPCL import get_k_nearest_by_variance, get_k_nearest_by_uncertainty
